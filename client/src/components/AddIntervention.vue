    ...
    <div v-if="showPopup" class="popup z-50">
      <div class="popup-content card w-96 bg-neutral ">
        <div class="card-body items-center text-center">
          ...
          <form @submit.prevent="postIntervention(); showPopup = false">
            ...
            <div class="grid grid-cols-2 gap-4">
              <div class="form-control">
                ...
                <input type="number" required v-model="model.Intervention.PPR" placeholder="Code" class="input input-bordered" pattern="[0-9]{7,}" title="Please enter at least 7 numbers." min="0" />
              </div>
<!--              <div class="form-control">-->
<!--                <label class="label">-->
<!--                  <span class="label-text">Etablissement</span>-->
<!--                </label>-->
<!--                <input type="text" required v-model="model.Intervention.NomEtab" placeholder="Etablissement"-->
...
<!--              </div>-->
              <div class="form-control">
                ...
                <input type="text" required v-model="model.Intervention.IntituleIntervention" placeholder="Intitule"
                  class="input input-bordered" />
              </div>
              <div class="form-control">
                <label class="label">
                ...
                <input type="text" required v-model="model.Intervention.AnneeUniv" placeholder="Année universitaire"
                  class="input input-bordered" />
              </div>
              <div class="form-control">
                <label class="label">
                ...
                <select required v-model="model.Intervention.Semestre" class="select select-bordered">
              ...
              <div class="form-control">
                ...
                <input type="date" required v-model="model.Intervention.DateDebut" placeholder="Date début"
                  class="input input-bordered" />
              </div>
              <div class="form-control">
                <label class="label">
                ...
                <input type="date" required v-model="model.Intervention.DateFin" placeholder="Date fin"
                  class="input input-bordered" />
              </div>
              <div class="form-control">
                <label class="label">
                ...
                <input type="number" required v-model="model.Intervention.NbrHeures" placeholder="Nombre d'heure"
                  class="input input-bordered" min="0"/>
              </div>
            </div>

            <div class="form-control mt-6 grid grid-cols-2 flex items-center">
              <button type="submit" class="btn btn-primary h-9" style="border-radius: 10px;">Add Intervention</button>
